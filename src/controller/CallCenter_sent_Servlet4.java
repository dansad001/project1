...
/**
 * Servlet implementation class CallCenter_sent_Servlet4
 */
@WebServlet("/CallCenter_sent_Servlet4")
public class CallCenter_sent_Servlet4 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CallCenter_sent_Servlet4() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			Order_DAO.sentdatamember4(data1, data2, data3, data4,data5, data6, data7, data8,data9, data10, data11, data12,data13, data14, data15, data16, data17,data18, data19, data20, data21, data22, data23,id);
